...
from apps.api.app.services.moderation.auto_recover import add_ban_sanction, add_mute_sanction
...
async def apply_moderation_action(
    ...
    if action == "kick":
        ...
        await add_ban_sanction(db, chat_id, user_id, reason, kick_minutes)
    ...
    if action == "ban":
        ...
        await add_ban_sanction(db, chat_id, user_id, reason, config.ban_minutes)
